...
- **Study buddy** — a capybara in a firefly costume keeps you company in the side panel and the fullscreen timer. Inline SVG, no assets and no requests: its lamp, wings and antennae take the current mode colour, it bobs and blinks its lamp while the timer runs, and closes its eyes with a drifting "z" when it is stopped. Turn it off with "Capybara study buddy" in the settings.
